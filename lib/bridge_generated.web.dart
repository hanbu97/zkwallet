...
class NativeWasmModule implements WasmModule {
  ...
  external dynamic /* void */ wire_multiply_zk(
      NativePortType port_, int a, int b);

  external dynamic /* void */ wire_pwd_and_ls(NativePortType port_);
}
...
class NativeWire extends FlutterRustBridgeWasmWireBase<NativeWasmModule> {
  ...
  void wire_multiply_zk(NativePortType port_, int a, int b) =>
      wasmModule.wire_multiply_zk(port_, a, b);

  void wire_pwd_and_ls(NativePortType port_) =>
      wasmModule.wire_pwd_and_ls(port_);
}
